  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-emerald-600">Soil & Crop Health Analysis</h1>
          <p className="text-gray-600 mt-1">AI-powered soil analysis and crop optimization</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">Soil Health Score</p>
              <p className="text-3xl font-bold text-gray-900">{soilHealthScore}</p>
              <div className="flex items-center mt-1">
                <TrendingUp className="w-4 h-4 text-green-500" />
                <span className="text-sm text-green-600 ml-1">+3 from last test</span>
              </div>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">Nutrient Balance</p>
              <p className="text-3xl font-bold text-gray-900">Good</p>
              <div className="flex items-center mt-1">
                <span className="text-sm text-yellow-600">1 deficiency detected</span>
              </div>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">Moisture Level</p>
              <p className="text-3xl font-bold text-gray-900">25%</p>
              <div className="flex items-center mt-1">
                <CheckCircle className="w-4 h-4 text-green-500" />
                <span className="text-sm text-green-600 ml-1">Optimal range</span>
              </div>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center mt-1">
                <CheckCircle className="w-4 h-4 text-green-500" />
                <span className="text-sm text-green-600 ml-1">Slightly acidic</span>
              </div>
            </div>
          ...
          {activeTab === 'upload' && (
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Upload Soil Sample</h3>
                  <div
